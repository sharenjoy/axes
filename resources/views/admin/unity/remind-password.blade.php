...
@section('title')
{{pick_trans('forgot_password')}} - {{session('cmsharenjoy.settings.general.brand_name')}}
@stop
    ...
    {!!Form::open(array('url'=>$accessUrl.'/remindpassword', 'method'=>'POST', 'role'=>'form'))!!}
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!!Form::text('email', old('email'), array('placeholder'=>pick_trans('insert_email'), 'class'=>'form-control'))!!}
            </div>
